...
"""
ArUco 마커 생성 스크립트
4x4_50 사전에서 ID 11부터 20까지 10개의 마커를 생성합니다.
"""
...
def generate_aruco_markers(output_dir, start_id=11, num_markers=10, marker_size=200, dict_type=cv2.aruco.DICT_4X4_50):
    """
    ...
    print(f"ArUco 마커 ID {start_id}~{start_id + num_markers - 1} ({num_markers}개) 생성 중...")
...
if __name__ == "__main__":
    ...
    # 마커 생성 (ID 11~20)
    generate_aruco_markers(script_dir, start_id=11, num_markers=10, marker_size=200)
